...
export function HospitalPortfolioPage(){
 ...
 {tab==='catalogo'&&<div className="card"><MiCarteraCatalog onSelect={({item})=>setSelected(item)}/>{selected&&<MiCarteraDynamicForm item={selected} onReady={saveItem}/>} {saving&&<p>Guardando configuración...</p>}</div>}
