...
export function HospitalPortfolioPage(){
 ...
 const establishmentId=profile?.establecimiento_id||null; const [cartera,setCartera]=useState(null); const [loadingCartera,setLoadingCartera]=useState(false); const [creating,setCreating]=useState(false);
